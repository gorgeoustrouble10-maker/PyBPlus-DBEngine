...
| **84+ Core Tests** | Full test coverage for tree, SQL, transactions, replication | 树、SQL、事务、复制全链路测试 |
| **Bloom Filter** | Introduced Bloom Filter for point-lookup optimization with mathematical proof | 点查优化，含假阳性率数学推导 |
...
- [Architecture Whitepaper](docs/PyBPlus-DBEngine_Architecture_WhitePaper.md) — Full design (Phase 1–27)
...
从 Phase 1 到 Phase 27，PyBPlus-DBEngine 已形成一条**从存储到分布式**的完整技术链：
